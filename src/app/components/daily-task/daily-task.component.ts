...
export class DailyTaskComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.time = Date.now();
    this.taskService.getDaily().subscribe((tasks) => {
      this.tasks = tasks;
    });
  ...
  addTask(e): void {
    ...
    this.taskService.addDaily(this.tasks);
  ...
  updateTask(event): void {
    ...
    this.taskService.updateDaily(this.task);
    this.taskService.getDaily().subscribe((tasks) => (this.tasks = tasks));
  }
  ...
  deleteAllTask(event) {
    event.preventDefault();
    this.taskService.deleteAllDaily();
    this.taskService.getDaily().subscribe((tasks) => (this.tasks = tasks));
  }
}
